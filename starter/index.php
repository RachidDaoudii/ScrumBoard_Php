				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="p-2">
						<div class="">
							...
							?>
							<h4 class="p-2 mb-0 bg-black text-light fs-6">To do (<span id="to-do-tasks-count"><?php ?>0</span>)</h4>
						</div>
						<div class="todo" id="to_do_tasks">
							...
							<?php
								...
								while ($element = mysqli_fetch_assoc($sql)){
									...
									<button class="w-100 bg-white border-0 border-secondary border-bottom d-flex button_task" name="edit" data-bs-toggle="modal" data-bs-target="#update<?php echo $element['Id']?>">
										<div class="fs-2">
									...
									<!-- <div  class="show w-100 bg-white border-0 border-secondary border-bottom d-flex" >
										<div class="fs-2">
										...
										<div class="p-2 text-start">
											...
											<div class="pt-1 d-flex justify-content-evenly">
												...
												<?php// include 'Update.php'?>
												<a class="up p-1 btn btn-secondary border border-0 text-black "  name="edit" data-bs-toggle="modal" data-bs-target="#update<?php //echo $element['Id']?>">Update</a>
												 <a class="up p-1 btn btn-red border border-0 text-black " href="index.php?edit=<?php// echo $element['Id'] ?>">Delete</a>
											</div>
										</div>
								</div>
								</div> -->
						...
						<div class="done" id="done-tasks">
							...
							<?php 
								...
								while ($element = mysqli_fetch_assoc($sql)){
									?>
									<?php include 'Update.php'?>
									<button class="show w-100 bg-white bg-white border-0 border-secondary border-bottom d-flex btn_update"name="edit" data-bs-toggle="modal" data-bs-target="#update<?php echo $element['Id']?>">
										<div class="fs-2">
